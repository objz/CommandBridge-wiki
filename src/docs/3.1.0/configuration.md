...
I was talking a lot about 'one Velocity instance', because CB supports **multi proxy setups**. What that exactly means is explained here: [Multi proxy](/docs/multi-proxy). 
